...
function anima_conditionals( $control ) {
	...
	$conditionals = array(
		...
		/* anima's caption is always visible */
		/* array(
		...
		array(
			'id'    => 'anima_lppostslayout',
			'parent'=> 'anima_lpposts',
			'value' => 1,
		),
		array(
			'id'    => 'anima_lppostscount',
			'parent'=> 'anima_lpposts',
			'value' => 1,
		),
		array(
...
'info_settings' => array(
	'plus_link' => array(
		...
		'desc' =>  sprintf( __('Find out what features you\'re missing out on and how the Plus version of %1$s can improve your site.', 'anima'), cryout_sanitize_tnl(_CRYOUT_THEME_NAME) ),
...
'sections' => array(
	...
	array('id'=>'anima_lpblocks1', 'title'=>__('Featured Icon Blocks','anima'), 'callback'=>'', 'sid'=>'anima_landingpage', 'priority' => 30 ),
	array('id'=>'anima_lpboxes1', 'title'=>__('Featured Boxes','anima'), 'callback'=>'', 'sid'=>'anima_landingpage', 'priority' => 40),
	array('id'=>'anima_lpboxes2', 'title'=>__('Featured Boxes 2','anima'), 'callback'=>'', 'sid'=>'anima_landingpage', 'priority' => 50),
	array('id'=>'anima_lptexts', 'title'=>__('Text Areas','anima'), 'callback'=>'', 'sid'=>'anima_landingpage', 'priority' => 60),
	array('id'=>'anima_lpfcontent', 'title'=>__('Featured Content','anima'), 'callback'=>'', 'sid'=>'anima_landingpage', 'priority' => 70),
	// text
...
'options' => array (
	...
	array(
	'id' => 'anima_headerhints',
		'type' => 'notice',
		'label' => '',
		'desc' => sprintf( __( 'Fine tune the visibility of these elements from the theme\'s %s','anima' ), '<a data-type="section" data-id="cryout-anima_headercontent" class="cryout-customizer-focus"><strong>' . __('Header options', 'anima') . ' &raquo;</strong></a>' ),
		'input_attrs' => array( 'class' => '' ),
		'priority' => 55,
		'addon' => TRUE, // this option gets added to built-in WordPress section
	'section' => 'title_tagline' ),
	array(
	'id' => 'anima_headerorbannerhint',
		'type' => 'notice',
		'label' => '',
		'desc' => sprintf( __( 'Configure the image currently visible on the homepage from the theme\'s options under %s','anima' ), '<a data-type="section" data-id="cryout-theme_lpslider" class="cryout-customizer-focus"><strong>' . __('Landing Page > Slider > Banner Image', 'anima') . ' &raquo;</strong></a>' ),
		'input_attrs' => array( 'class' => '' ),
		'priority' => 9,
	...
	array(
	'id' => 'anima_identityhints',
		'type' => 'notice',
		'input_attrs' => array( 'class' => '' ),
		'label' => '',
		'desc' => sprintf( __( 'Edit the site\'s title, tagline and logo from the %s panel','anima' ), '<a data-type="section" data-id="title_tagline" class="cryout-customizer-focus"><strong>' . __('Site Identity', 'anima') . ' </strong></a>' ),
	'section' => 'anima_headercontent' ),
	array(
	...
	'id' => 'anima_lpslider',
		...
		'labels' => array(
			__("Serious Slider", "anima"),
			__("Use Shortcode","anima"),
			__("Banner Image","anima"),
			__("Header Image","anima"),
			__("Disabled","anima")
		),
	...
	'id' => 'anima_lpsliderimage',
		'type' => 'media-image',
		'label' => __('Banner Image','anima'),
		'desc' => __('The default image can be replaced by setting a new banner image.', 'anima'),
		'active_callback' => 'anima_conditionals',
	'section' => 'anima_lpslider' ),
	array(
	'id' => 'anima_lpsliderlink',
		'type' => 'url',
		'label' => __('Banner Link','anima'),
		'desc' => '',
		'active_callback' => 'anima_conditionals',
	'section' => 'anima_lpslider' ),
	array(
	...
	'id' => 'anima_lpblockscontent#',
		...
		'labels' => array( __("Disabled","anima"), __("No Text","anima"), __("Excerpt","anima"), __("Full Content","anima") ),
		'desc' => '',
		'priority' => 20,
	'section' => 'anima_lpblocks#' ),
	array(
	'id' => 'anima_lpblocksreadmore#',
		'type' => 'text',
		'label' => __('Read More Button','anima'),
		'desc' => __("Configure the 'Read More' link text.","anima"),
		'priority' => 22,
	'section' => 'anima_lpblocks#' ),
	array(
	...
	'id' => 'anima_lptexthint',
		'type' => 'hint',
		'label' => '',
		'desc' => __("Page properties that will be used:<br>- page title as text title<br>- page content as text content<br>- page featured image as text area background image","anima"),
		'priority' => 99,
	'section' => 'anima_lptexts' ),
	...
	'id' => 'anima_articleanimation',
		...
		'values' => array( 'none', 'fade', 'slide', 'slideLeft', 'slideRight'),
...
'migration' => array(
	'1.21' => array(
		//'anima_old_key' => 'anima_new_key',
		'anima_lpblockmaintitle'	=> 'anima_lpblockmaintitle1', // icon blocks
		'anima_lpblockmaindesc'		=> 'anima_lpblockmaindesc1',
		'anima_lpblockscontent' 	=> 'anima_lpblockscontent1',
		'anima_lpblocksclick' 		=> 'anima_lpblocksclick1',
		'anima_lpblocksreadmore' 	=> 'anima_lpblocksreadmore1',
		'anima_lpblockoneicon' 		=> 'anima_lpblockoneicon1',
		'anima_lpblockone' 			=> 'anima_lpblockone1',
		'anima_lpblocktwoicon' 		=> 'anima_lpblocktwoicon1',
		'anima_lpblocktwo' 			=> 'anima_lpblocktwo1',
		'anima_lpblockthreeicon' 	=> 'anima_lpblockthreeicon1',
		'anima_lpblockthree' 		=> 'anima_lpblockthree1',
		'anima_lpblockfouricon' 	=> 'anima_lpblockfouricon1',
		'anima_lpblockfour' 		=> 'anima_lpblockfour1',
	) // 1.2.1
),	// migration
...
ksort( $anima_big['block-icons'] );
$anima_big['block-icons'] = array_merge( array( 'no-icon' => '&nbsp;') , $anima_big['block-icons'] );
