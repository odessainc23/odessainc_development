...
function anima_get_option_defaults() {
	...
	"anima_lpblockthree1"		=> $sample_pages[3],
	"anima_lpblockthreeicon1"	=> 'equalizer',
	"anima_lpblockfour1"			=> 0,
	"anima_lpblockfouricon1"		=> 'megaphone',
	...
	"anima_articleanimation"	=> "slideLeft", // 0=none, >0=effect
