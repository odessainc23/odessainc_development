$(function() {
  ...
  $('.postid-1117 .pr_announcementimg').append($('<div><b>People in the photo (left to right) are:</b><br> Ankit Parikh, AVP - Leasing Business, Tata Motors Finance; Campbell Clout, MD - APMEA, Odessa; Anand Bang, COO – Sales & Marketing, Tata Motors Finance; Neeloy Majumder, COO – Technology, Tata Motors Finance</div>'))
});
