...
function anima_setup() {
	...
	add_theme_support( 'editor-color-palette', array(
		array(
			'name' => __( 'Accent #1', 'anima' ),
			'slug' => 'accent-1',
			'color' => $options['anima_accent1'],
		),
		array(
			'name' => __( 'Accent #2', 'anima' ),
			'slug' => 'accent-2',
			'color' => $options['anima_accent2'],
		),
		array(
			'name' => __( 'Content Headings', 'anima' ),
			'slug' => 'headings',
			'color' => $options['anima_headingstext'],
		),
 		array(
			'name' => __( 'Site Text', 'anima' ),
			'slug' => 'sitetext',
			'color' => $options['anima_sitetext'],
		),
		array(
			'name' => __( 'Content Background', 'anima' ),
			'slug' => 'sitebg',
			'color' => $options['anima_contentbackground'],
		),
 	) );
...
add_action( 'enqueue_block_editor_assets', 'anima_gutenberg_editor_styles' );
