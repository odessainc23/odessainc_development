		...
		<div class="footer_menuwr clearfix">
			...
			<div class="footer_li_wrap">
				...
				<ul>
					...
					<li><a href="<?php echo OD_BASE_URL ?>auto-finance-software" hreflang="en">Odessa Auto Finance</a></li>
...
$('#cc-nb-text').html("We use cookies to enhance your browsing experience, serve personalized content, and analyze our traffic. By clicking 'Accept', you consent to our use of cookies. For more details, check our <a href='https://dev.odessainc.com/cookie-notice' target='_blank'>Cookie Notice</a>.");
$(".cc-nb-okagree").html("Accept");
