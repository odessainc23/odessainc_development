...
return array(
    ...
    'BG' => array( // Bulgarian states.
        ...
        'BG-23' => __('Sofia', 'wp-user-avatar'),
        'BG-22' => __('Sofia-Grad', 'wp-user-avatar'),
    ...
    'NZ' => array( // New Zealand states.
        'NL' => __('Northland', 'wp-user-avatar'),
        'AK' => __('Auckland', 'wp-user-avatar'),
        'WA' => __('Waikato', 'wp-user-avatar'),
        'BP' => __('Bay of Plenty', 'wp-user-avatar'),
        'TK' => __('Taranaki', 'wp-user-avatar'),
        'GI' => __('Gisborne', 'wp-user-avatar'),
        'HB' => __('Hawke’s Bay', 'wp-user-avatar'),
        'MW' => __('Manawatu-Wanganui', 'wp-user-avatar'),
        'WE' => __('Wellington', 'wp-user-avatar'),
        'NS' => __('Nelson', 'wp-user-avatar'),
        'MB' => __('Marlborough', 'wp-user-avatar'),
        'TM' => __('Tasman', 'wp-user-avatar'),
        'WC' => __('West Coast', 'wp-user-avatar'),
        'CT' => __('Canterbury', 'wp-user-avatar'),
        'OT' => __('Otago', 'wp-user-avatar'),
        'SL' => __('Southland', 'wp-user-avatar'),
    ),
    ...
    'UA' => array( // Ukrainian oblasts.
        'VN' => __('Vinnytsia Oblast', 'wp-user-avatar'),
        'VL' => __('Volyn Oblast', 'wp-user-avatar'),
        'DP' => __('Dnipropetrovsk Oblast', 'wp-user-avatar'),
        'DT' => __('Donetsk Oblast', 'wp-user-avatar'),
        'ZT' => __('Zhytomyr Oblast', 'wp-user-avatar'),
        'ZK' => __('Zakarpattia Oblast', 'wp-user-avatar'),
        'ZP' => __('Zaporizhzhia Oblast', 'wp-user-avatar'),
        'IF' => __('Ivano-Frankivsk Oblast', 'wp-user-avatar'),
        'KV' => __('Kyiv Oblast', 'wp-user-avatar'),
        'KH' => __('Kirovohrad Oblast', 'wp-user-avatar'),
        'LH' => __('Luhansk Oblast', 'wp-user-avatar'),
        'LV' => __('Lviv Oblast', 'wp-user-avatar'),
        'MY' => __('Mykolaiv Oblast', 'wp-user-avatar'),
        'OD' => __('Odessa Oblast', 'wp-user-avatar'),
        'PL' => __('Poltava Oblast', 'wp-user-avatar'),
        'RV' => __('Rivne Oblast', 'wp-user-avatar'),
        'SM' => __('Sumy Oblast', 'wp-user-avatar'),
        'TP' => __('Ternopil Oblast', 'wp-user-avatar'),
        'KK' => __('Kharkiv Oblast', 'wp-user-avatar'),
        'KS' => __('Kherson Oblast', 'wp-user-avatar'),
        'KM' => __('Khmelnytskyi Oblast', 'wp-user-avatar'),
        'CK' => __('Cherkasy Oblast', 'wp-user-avatar'),
        'CH' => __('Chernihiv Oblast', 'wp-user-avatar'),
        'CV' => __('Chernivtsi Oblast', 'wp-user-avatar'),
    ),
