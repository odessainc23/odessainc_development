...
use ProfilePressVendor\Carbon\Exceptions\EndLessPeriodException;
...
use ProfilePressVendor\Carbon\Exceptions\InvalidPeriodDateException;
use ProfilePressVendor\Carbon\Exceptions\InvalidPeriodParameterException;
use ProfilePressVendor\Carbon\Exceptions\NotACarbonClassException;
use ProfilePressVendor\Carbon\Exceptions\NotAPeriodException;
use ProfilePressVendor\Carbon\Exceptions\UnknownGetterException;
use ProfilePressVendor\Carbon\Exceptions\UnknownMethodException;
use ProfilePressVendor\Carbon\Exceptions\UnreachableException;
...
class CarbonPeriod implements Iterator, Countable, JsonSerializable
{
    ...
    {
        if (\is_a($this->dateClass, DateTimeImmutable::class, \true)) {
