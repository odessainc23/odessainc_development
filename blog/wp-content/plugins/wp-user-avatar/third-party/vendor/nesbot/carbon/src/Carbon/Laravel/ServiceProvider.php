 ...
 */
namespace ProfilePressVendor\Carbon\Laravel;
...
use ProfilePressVendor\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use ProfilePressVendor\Illuminate\Events\Dispatcher;
use ProfilePressVendor\Illuminate\Events\EventDispatcher;
...
class ServiceProvider extends \ProfilePressVendor\Illuminate\Support\ServiceProvider
{
    ...
    public function boot()
    {
        ...
        if ($this->isEventDispatcher($events)) {
            $events->listen(\class_exists('ProfilePressVendor\\Illuminate\\Foundation\\Events\\LocaleUpdated') ? 'Illuminate\\Foundation\\Events\\LocaleUpdated' : 'locale.changed', function () use($service) {
