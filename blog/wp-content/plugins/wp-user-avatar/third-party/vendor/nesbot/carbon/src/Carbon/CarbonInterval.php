...
use ProfilePressVendor\Carbon\Exceptions\BadFluentConstructorException;
use ProfilePressVendor\Carbon\Exceptions\BadFluentSetterException;
use ProfilePressVendor\Carbon\Exceptions\InvalidCastException;
use ProfilePressVendor\Carbon\Exceptions\InvalidIntervalException;
use ProfilePressVendor\Carbon\Exceptions\OutOfRangeException;
use ProfilePressVendor\Carbon\Exceptions\ParseErrorException;
use ProfilePressVendor\Carbon\Exceptions\UnitNotConfiguredException;
use ProfilePressVendor\Carbon\Exceptions\UnknownGetterException;
use ProfilePressVendor\Carbon\Exceptions\UnknownSetterException;
use ProfilePressVendor\Carbon\Exceptions\UnknownUnitException;
use ProfilePressVendor\Carbon\Traits\IntervalRounding;
use ProfilePressVendor\Carbon\Traits\IntervalStep;
use ProfilePressVendor\Carbon\Traits\MagicParameter;
...
use Closure;
use DateInterval;
use ProfilePressVendor\DateMalformedIntervalStringException;
...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
    ...
    public static function __callStatic($method, $parameters)
    {
        try {
            ...
            $interval->localStrictModeEnabled = \true;
    ...
    public function multiply($factor)
    {
        ...
        return $this->copyProperties(static::create($yearPart)->microseconds(\abs($this->totalMicroseconds) * $factor)->cascade(), \true);
    }
    /**
     ...
     * @return bool
     */
    public function between($interval1, $interval2, $equal = \true) : bool
    {
    ...
    {
        return $this->between($interval1, $interval2, \true);
    }
    /**
     * Determines if the instance is between two others, bounds excluded.
     *
     ...
     * @return bool
     */
    public function isBetween($interval1, $interval2, $equal = \true) : bool
    {
