...
namespace ProfilePressVendor\Stripe\Treasury;
 ...
 */
class FinancialAccount extends \ProfilePressVendor\Stripe\ApiResource
{
    ...
    public function retrieveFeatures($params = null, $opts = null)
    {
        ...
        $obj = \ProfilePressVendor\Stripe\Util\Util::convertToStripeObject($response, $opts);
        $obj->setLastResponse($response);
        return $obj;
    }
    /**
