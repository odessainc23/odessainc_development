...
namespace ProfilePressVendor\Stripe\V2;
 ...
 */
class Collection extends \ProfilePressVendor\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \ProfilePressVendor\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \ProfilePressVendor\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \ProfilePressVendor\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
