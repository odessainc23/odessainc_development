 ...
 */
class FileService extends \ProfilePressVendor\Stripe\Service\AbstractService
{
    /**
    ...
    public function create($params = null, $opts = null)
    {
        ...
        $flatParams = \array_column(\ProfilePressVendor\Stripe\Util\Util::flattenParams($params), 1, 0);
