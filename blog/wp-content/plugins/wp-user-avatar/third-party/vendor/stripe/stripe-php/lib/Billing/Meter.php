...
namespace ProfilePressVendor\Stripe\Billing;
 ...
 */
class Meter extends \ProfilePressVendor\Stripe\ApiResource
{
    const OBJECT_NAME = 'billing.meter';
    use \ProfilePressVendor\Stripe\ApiOperations\NestedResource;
