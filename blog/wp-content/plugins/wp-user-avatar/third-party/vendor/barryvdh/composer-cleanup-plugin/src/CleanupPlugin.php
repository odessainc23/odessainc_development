...
namespace ProfilePressVendor\Barryvdh\Composer;

use ProfilePressVendor\Composer\Composer;
use ProfilePressVendor\Composer\EventDispatcher\EventSubscriberInterface;
use ProfilePressVendor\Composer\IO\IOInterface;
use ProfilePressVendor\Composer\Plugin\PluginInterface;
use ProfilePressVendor\Composer\Script\ScriptEvents;
use ProfilePressVendor\Composer\Installer\PackageEvent;
