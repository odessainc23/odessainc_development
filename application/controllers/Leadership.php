...
class Leadership extends CI_Controller {
	...
	public function get_list() {
		return array(
			array(
				'name'			=> 'Eric Bernstein',
				'thumbnail'		=> base_url() .'assets/images/leadership/eric.webp',
				'title'			=> 'CEO',
			...
			array(
				...
				'thumbnail'		=> base_url() .'assets/images/leadership/sumit-maheshwari.webp',
				'title'			=> 'CFO',
			...
			array(
				...
				'thumbnail'		=> base_url() .'assets/images/leadership/JasonStLaurent_Odessa.webp',
				'title'			=> 'COO',
			...
			array(
				...
				'thumbnail'		=> base_url() .'assets/images/leadership/roopa-jayaraman.webp',
				'title'			=> 'CTO',
			...
			array(
				'name'			=> 'Jeff Lezinski',
				'thumbnail'		=> base_url() .'assets/images/leadership/jeff-lezinski.webp',
			...
			array(
				'name'			=> 'Andrew Baird',
				'thumbnail'		=> base_url() .'assets/images/leadership/andrew.webp',
			...
			array(
				'name'			=> 'Campbell Clout',
				'thumbnail'		=> base_url() .'assets/images/leadership/campbell.webp',
			...
			array(
				...
				'thumbnail'		=> base_url() .'assets/images/leadership/AlexandreEllwood_Odessa.webp',
				'title'			=> 'SVP, Business Development',
			...
			array(
				'name'			=> 'Scott Frymire',
				'thumbnail'		=> base_url() .'assets/images/leadership/scott.webp',
