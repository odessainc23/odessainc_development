                     ...
                     <div class="annoucement_div upperdiv">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12 nopad">
                           <div class="annoucement_rt">
                              ...
                              <p><a href="<?php echo base_url(); ?>blog/<?= $result[$i]->post_name; ?>" class="odc__btn--more odc__btn--xl" target="_blank">Read more </a></p>
                           </div>
                        </div>
                        <?php } ?>
                     </div>
                     <div class="bottomdiv">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 pd10">
                           <div class="annoucement_div">
                              ...
                              <p><a href="<?php echo base_url(); ?>blog/<?= $result[$i+1]->post_name; ?>" class="odc__btn--more odc__btn--xl" target="_blank">Read more </a></p>
                           </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 pd10">
                           <div class="annoucement_div">
                              ...
                              <p><a href="<?php echo base_url(); ?>blog/<?= $result[$i+2]->post_name; ?>" class="odc__btn--more odc__btn--xl" target="_blank">Read more </a></p>
                           </div>
                        </div>
                        <?php } ?>
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-12 pd10">
                           <div class="annoucement_div">
                              ...
                              <p><a href="<?php echo base_url(); ?>blog/<?= $result[$i+3]->post_name; ?>" class="odc__btn--more odc__btn--xl" target="_blank">Read more </a> </p>
                           </div>
                        </div>
                        <?php } ?>
                     </div>
            ...
            <div class="news_div upperdiv">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12 nopad">
                  <div class="news_rt">
                     ...
                     <!-- <h3></h3> -->
                     <h3>Odessa Taps Fintech Expert Nate Montgomery to Lead Global Sales as Chief Revenue Officer</h3>
                     <p><a href="https://www.einpresswire.com/article/713691566/odessa-taps-fintech-expert-nate-montgomery-to-lead-global-sales-as-chief-revenue-officer" class="odc__btn--more odc__btn--xl" target="_blank">Read more</a></p>
                  </div>
               </div>
            </div>
            <div class="bottomdiv">
