...
Yann Toutant<a href="<?php echo base_url(); ?>whitepaper/rethink-asset-finance-master-pay-per-use" class="odc__btn odc__btn--primary odc__btn--md covid-alert__link alert-link" style="text-decoration: none;margin-left: 10px;height: 35px;min-width:100px;font-weight:400;">Download here</a> 
