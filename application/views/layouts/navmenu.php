                        ...
                        <div class="covid-alert">
                            <div class="alert  alert-dismissible fade in ">
								...
								<p class="covid-alert__para text-center" style="font-size: 18px;">
                                                                ...
                                                                White Paper Alert: Mastering Pay-Per-Use in Asset Finance - with Inputs from
Yann Toutant<a href="<?php echo base_url(); ?>whitepaper/master-as-a-service-offerings-asset-finance-whitepaper" class="odc__btn odc__btn--primary odc__btn--md covid-alert__link alert-link" style="text-decoration: none;margin-left: 10px;height: 35px;min-width:100px;font-weight:400;">Download here</a> 
	...
	<div class="container">
		...
		<div class="navbar_wrapper row">  <div class="nav-flex">
