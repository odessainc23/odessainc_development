                        ...
                        <div class="covid-alert">
                            <div class="alert  alert-dismissible fade in ">
                                ...
                                <p class="covid-alert__para text-center" style="font-size: 18px;">
																...
																Our new handbook on ‘The Business Case for Next-Gen Auto Platform’<a href="<?php echo base_url(); ?>handbook/next-gen-auto-platform" class="odc__btn odc__btn--primary odc__btn--md covid-alert__link alert-link" style="text-decoration: none;margin-left: 10px;height: 35px;min-width:100px;font-weight:400;">Access Here</a> 
