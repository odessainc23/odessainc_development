		...
		<div class="footer_menuwr clearfix">
			...
			<div class="footer_li_wrap">
				...
				<ul>
					...
					<li><a href="<?php echo base_url(); ?>automative-finance-software" hreflang="en">Automative Finance</a></li>
			...
			<div class="stripfbox">
				<div class="socailicons_newsletter">
					...
					<div class="social_icon"> 
						...
						<a href="https://twitter.com/OdessaTech" target="_blank">                       <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512" style="width: 19px;height: 19px;fill: #fff;"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/></svg></a> 
